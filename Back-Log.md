...
**05/01/25 - 16:10 - 19:05 - Thiago:**
Fiz as funções de empate, sua lógica de verificação e monte ajustavel, além de 
receber da função de clicagem.;


**06/01/25 - 08:40 - 10:45 - Thiago:**
Coloquei para exibir a pilha de cartas no empate, e coloquei para que essa pilha
fosse distribuida após checar uma nova vitória de um dos dois.;


**06/01/25 - 11:00 - 12:10 - Gabriel:**
Resolvi alguns bug na parte do jogo singlepayer, deixando quase 100%, faltando apenas
colocar os efeitos adicionais de exibição, mas as funções estão prontas!;


**06/01/25 - 21:33 - 22:24 - Gabriel:**
Consertei um bug no editar do gerenciador, e transferi as funções auxiliares do jogo
singleplayer para o arquivo correto delas, comentei e identei quanto foi possivel,
faltando *sons nesse menu e detalhes do desenho*.;


**10/01/25 - 03:12 - 03:48 - Gabriel:**
Começei as funções de red, colocando a primeira função que é chamada quando a tela de jogo multiplayer
é aberta, ela conecta ao servidor, retornando true se a conexão for bem sucedida, ou false se não,
isso é util para deixar o usuário prosseguir nos submenus desse menu, somente se esse conect_server
for 1, que é o estado de conxão ok.;


**10/01/25 - 20:00 - 22:45 - Gabriel e Gustavo:**
Fizemos o design do menu de jogo multiplayer, colocando os botões e a caixa de texto para receber o código.;


**11/01/25 - 08:20 - 11:03 - Gabriel:**
Começei a fazer as verificações do submenu 0 e 1, do multiplayer, escrevendo para isso
as funções de criar seção no server, destruir seção e ler dados 1, futuramente, irei colocar
a ler dados 2 e a escrever dados, mas a base é bem similar de construção, agora é começar a trabalhar
no submenu 2 que de fato é o jogo e na conexão do player 2, além dos gets e sets dessas funções.;


**11/01/25 - TARDE - Gabriel, Gustavo e Thiago:**
Enquanto o thiago estava pesquisano profundamente sons, musicas e efeitos sonoros para o jogo,
o gabriel e gustavo estavam acabando as partes do multiplayer, finalizando quase tudo, apenas
ficando para fazer a condição de vitória dos players, e os testes profundos em todo o código,
além de claro, fazer o resto dos complementos e adições de desenho, fora isso já foi realizado
hoje ainda, um teste de jogo no multiplayer entre as maquinas do Gustavo e do Gabriel, aparentemente
tudo ok, mas a bateria de testes ainda será realizada, quando o jogo estiver 99,5% finalizado.;


**12/01/25 - 09:20 - 14:33 - Gabriel:**
Acabei as funções do multiplayer, todo o planejamento apra esse menu foi satisfeito, agora
os próximos detalhes são colocar as funções de resaltar para funcionar nesse menu e verificar,
algumas inconsistencias gerais no código, além de identar e comentar tudo, e inciar as baterias
de teste.;


**12/01/25 - 21:01 - 22:04 - Gabriel:**
Fiz o botão de reset de cartas do gerenciador, que ele irá resetar o vetor de cartas para 
as cartas originais do banco. Além de ajustar todas as funções de resalta de todos os menus.


**13/01/25 - 16:05 - 18:17 - Thiago e Gabriel:**
Definimos os efeitos sonoros das proximas etapas do joogo, além de testarmos o modo multiplayer, que
acusou alguns erros de desincronização de cartas, o thiago irá encontrar esses erros enquanto
gabriel arruma os problemas de imcopatibilidade com o linux, além de o quanto antes fazermos o teste
denominado "caminho do jogo".;


**14/01/25 - 13:02 - 17:25 - Thiago:**
Começei a fazer a funções que exibem em arquivos os baralhos do player 1 e 2 do multiplayer
para rastrear o erro das cartas dessincronizadas.;


**15/01/25 - TARDE - Gabriel e Thiago:**
Verificamos a fonte da desincronização do jogo e atestamos que era realmente na função de empate que
colocava em ordem diferente as cartas dependendo do player, arrumou-se passando para essa função o tipo
de player e por consequencia ela coloca agora na ordem correta para ambos.;


**16/01/25 - 19:02 - 22:22 - Gabriel:**
Começei a arrumar os grandes problemas do jogo, os erros principais, eram relacionado aos
desenhos dos menus, que crashava em linux, depois de arrumado, voltou a funcionar ok, 
além disso começei também a rearumar as funções gerais, melhorando as passagens e desempenho
delas.;


**17/01/25 - 13:05 - 17:10 - Gabriel:**
Arrumei mais alguns pequenos problemas do código, otimizei funções de rede, e coloquei
os sons adicionais para funcionar, além de arrumar alguns detalhes do som sobbtn que
estavam travados, agora oficialmente é a reta final da programação do jogo, e não há mais nada
para implementar, apenas corrigir pequenos problemas, e otimizar o jogo por completo.;


**11/02/2024 - DIA TODO - Gabriel, Gustavo e Thiago:**
Ultima pincelada pelo código, arrumando pequenos problemas e arrumando detalhes
para a entrega final.;


#Tempo estimado de criação do jogo total: 194hrs : 28mins